...
const PARTS = [
  ...
  {
    id: "registrationWorkshops", title: "Workshops by phone",
    hint: "The side panel that sends people to the office to book a workshop. The number itself is in Workshops — words.",
    fields: many([
      ["reg_ws_title", "Workshop panel: title"], ["reg_ws_text", "Workshop panel: text"], ["reg_ws_more", "Workshop panel: link to the workshops page"],
    ]),
  },
  {
...
export const GROUPS = [
  ...
  },
  {
    ...
    blocks: [
      ...
      text("registrationWorkshops", "Workshops by phone"),
