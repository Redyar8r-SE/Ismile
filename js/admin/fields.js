...
const PARTS = [
  ...
  },
  {
    ...
    fields: many([
      ...
      ["w_price_seat", "Under the price"], ["w_reserve", "Reserve seat button"], ["w_reserved", "Badge on a workshop already in their order"],
      ...
      ["w_gate_or", "Popup: word between the two choices"],
      ["w_gate_have", "Popup: I have a reference button"], ["w_gate_name", "Popup: full name label"],
      ["w_gate_email", "Popup: email label"], ["w_gate_ref", "Popup: reference label"],
      ["w_gate_continue", "Popup: continue button"],
  ...
  },
  {
    ...
    fields: many([
      ...
      ["ws_skip", "Continue button when nothing is selected"], ["ws_reserved", "Badge: already in their order"],
  ...
  },
  {
    ...
    fields: many([
      ...
      ["success_addon_title", "Title after adding workshops"], ["success_addon_text", "Success text after adding workshops (keep {method}, {total} and {email})"],
