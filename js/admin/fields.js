...
const PARTS = [
  ...
  },
  {
    ...
    fields: many([
      ...
      ["f_age", "Age label"], ["ph_age", "Age hint"], ["f_spec", "Specialty label"],
  ...
  },
  {
    ...
    hint: "The second step, review box, agreement and navigation buttons.",
    fields: many([
...
export const GROUPS = [
  ...
  {
    id: "registration", title: "Registration page", where: "The separate two-step registration page",
    blocks: [
      ...
      text("registrationPayment", "Step 2: payment and review"),
